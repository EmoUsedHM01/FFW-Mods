...
const patches = [
  { name: "rarity slot cost 5 -> 3 (case 0)", jsonOffset: 0x280, rawOffset: 0x3b03, expected: Buffer.from("1d05000000", "hex"), replacement: intConst3 },
  { name: "rarity slot cost 5 -> 3 (case 1)", jsonOffset: 0x2a7, rawOffset: 0x3b2a, expected: Buffer.from("1d05000000", "hex"), replacement: intConst3 },
  { name: "rarity slot cost 4 -> 2", jsonOffset: 0x2ce, rawOffset: 0x3b51, expected: Buffer.from("1d04000000", "hex"), replacement: intConst2 },
  { name: "rarity slot cost 3 -> 2", jsonOffset: 0x2f5, rawOffset: 0x3b78, expected: Buffer.from("1d03000000", "hex"), replacement: intConst2 },
